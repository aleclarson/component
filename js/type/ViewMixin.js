...
["render", "isRenderPrevented", "shouldUpdate", "willReceiveProps", "willMount", "didMount", "willUnmount", "defineNativeValues", "defineListeners", "defineReactions", "defineStyles", "appendStyles", "overrideStyles"].forEach(function(key) {
  return typeImpl.prototype[key] = {
    value: function(func) {
...
instImpl.initInstance = function(options) {
  ...
  mutable.define(this, $.props, {
    value: null
  });
  mutable.define(this, $.view, {
    value: null
  });
  return mutable.define(this, $.styles, {
    value: options.styles || null
  });
};
...
//# sourceMappingURL=map/ViewMixin.map
